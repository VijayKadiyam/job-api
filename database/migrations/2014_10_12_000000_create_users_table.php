...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('passing_marks_10')->nullable();
            $table->string('total_marks_10')->nullable();
            $table->string('passing_marks_12')->nullable();
            $table->string('total_marks_12')->nullable();
            ...
            $table->string('ipcc_group_2_marks')->nullable();
